      ...
      `} style={{ background: '#161b22' }}>
        ...
        <div className="flex items-center justify-between px-4 py-3 border-b border-white/6">
          <Link href="/admin" className="flex items-center gap-2.5">
            <img src="/icons/icon-192x192.png" alt="Alash Electronics" className="w-8 h-8 rounded-lg object-contain" />
            <span className="text-[13px] font-semibold text-white/90 truncate">Alash Electronics</span>
          </Link>
