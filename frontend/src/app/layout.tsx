...
export const metadata: Metadata = {
  ...
  title: {
    default: 'ИП КРУН — Интернет-магазин в Казахстане',
    template: '%s | ИП КРУН',
  },
  ...
  openGraph: {
    ...
    locale: 'ru_KZ',
    type: 'website',
    title: 'ИП КРУН — Интернет-магазин в Казахстане',
    description: 'ИП КРУН — интернет-магазин в Казахстане. Широкий ассортимент товаров, доставка по всему Казахстану.',
    images: [{ url: '/og-image.jpg', width: 1200, height: 630, alt: 'ИП КРУН — интернет-магазин' }],
  },
  twitter: {
