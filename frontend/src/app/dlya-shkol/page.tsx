...
export const metadata: Metadata = {
  title: { absolute: 'Наборы для школ и кружков робототехники | ИП КРУН' },
  ...
  openGraph: {
    title: 'Наборы для школ и кружков робототехники | ИП КРУН',
    ...
    url: '/dlya-shkol',
    locale: 'ru_KZ',
    images: [{ url: '/images/logo.png', width: 600, height: 300, alt: 'Наборы для школ — ИП КРУН' }],
  },
}
...
const faqItems = [
  {
    ...
    a: 'Да. ИП КРУН работает с юридическими лицами — школами, STEM-центрами, акиматами, частными учебными организациями. Выставляем счёт-фактуру, предоставляем накладную и акт выполненных работ. ИП на упрощёнке, НДС не облагается. Для государственных закупок готовим полный комплект документов под процедуру ГЦВП.',
  },
  {
  ...
  },
  {
    ...
    a: 'Стандартные сроки: Костанай — 1–2 рабочих дня (курьер), другие города Казахстана — 3–7 рабочих дней (inDrive или СДЭК). Для крупных заказов (20+ комплектов) согласовываем индивидуальный срок и возможность частичной отгрузки. При срочной потребности к учебному году рекомендуем оформить заказ минимум за 2 недели.',
  },
  {
    q: 'Есть ли техническая поддержка после покупки наборов для кружков?',
    a: 'Да. При покупке наборов для кружков и классов предоставляем: доступ к методическому материалу в электронном виде, онлайн-консультацию педагога в течение месяца после покупки (Telegram/WhatsApp), ссылки на видеоуроки и примеры проектов на русском языке. По запросу организуем выездной мастер-класс в Костанай.',
  },
]
    ...
    <div className="max-w-[1400px] mx-auto px-4 py-6 flex flex-col lg:flex-row gap-6">
      ...
      <main className="flex-1 min-w-0">
        ...
        <p className="text-gray-600 text-sm mb-6 leading-relaxed">
          ИП КРУН — поставщик образовательных наборов по робототехнике и электронике для школ и учебных организаций Казахстана.
        ...
        <article className="prose prose-sm max-w-none text-gray-700 space-y-5">
          ...
          <h2 className="text-xl font-bold text-gray-900 not-prose">Почему школы Казахстана выбирают ИП КРУН</h2>

          <p>
            ИП КРУН работает в Костанай с 2019 года и специализируется на поставках образовательного оборудования
            для кружков робототехники, STEM-лабораторий и уроков технологии. За это время мы выполнили поставки в
            более чем 40 школ и учебных центров Казахстана — в Костанай, Нур-Султане, Шымкенте, Актау и других городах.
          </p>
          <p>
            ...
            Все наборы в наличии на складе в Костанай — заказы комплектуются и отправляются в день оформления.
          </p>
          ...
          <p>
            В ИП КРУН доступны комплекты для оснащения класса:
          ...
          <p>
            Для кружков рекомендуем наш <strong>Расширенный обучающий набор Arduino от ИП КРУН</strong> (25 000 ₸) —
          ...
          <p>
            mBot широко используется в STEM-классах школ Костанай — Haileybury Almaty, QSI, ряде школ НИШ.
            В ИП КРУН доступен в двух версиях: стандартный (Bluetooth) и mBot Pro (Bluetooth + Wi-Fi, поддержка Python).
          </p>
          ...
          <p>
            ИП КРУН предлагает <strong>Raspberry Pi 4 Model B</strong> (4 ГБ, 89 000 ₸) и
          ...
          <div className="not-prose overflow-x-auto">
            <table className="w-full text-sm border-collapse">
              ...
              <tbody className="text-gray-700">
                ...
                <tr>
                  <td className="border border-gray-200 px-3 py-2">Arduino Starter (Croon)</td>
          ...
          <p>
            ИП КРУН — официально зарегистрированное ИП в Казахстане. Работаем по безналичному расчёту:
          ...
          <div className="bg-gray-50 border border-gray-200 rounded-lg p-4 my-3 text-sm text-[#333] not-prose space-y-1">
            <p className="font-bold text-gray-800 mb-1">Реквизиты для оплаты:</p>
            <p><strong>Компания:</strong> ИП КРУН</p>
            <p><strong>Адрес:</strong> Костанай Г.А., Костанай, МИКРОРАЙОН 9, дом 7, кв/офис 9</p>
            <p><strong>БИН (ИИН):</strong> 970821450592</p>
            <p><strong>Банк:</strong> АО &quot;Kaspi Bank&quot;</p>
            <p><strong>КБе:</strong> 19</p>
            <p><strong>БИК:</strong> CASPKZKA</p>
            <p><strong>Номер счета:</strong> KZ69722S000008539256</p>
          </div>
          ...
          <ul className="list-disc list-inside space-y-1 text-gray-700 not-prose">
            ...
            <li>Бесплатная доставка по Костанаю при заказе от 150 000 ₸</li>
          </ul>
          ...
          <p>
            По запросу организуем <strong>выездной мастер-класс</strong> для педагогов в Костанай — знакомство с платформой,
          ...
          <p>
            ...
            После подтверждения оплаты отгружаем товар со склада в Костанай.
          </p>
          <p>
            <strong>Шаг 4.</strong> Доставка по Костанаю — 1–2 рабочих дня (курьер).
            По всему Казахстану — 3–7 рабочих дней (inDrive, СДЭК или транспортной компанией по выбору заказчика).
            Самовывоз: Костанай Г.А., Костанай, МИКРОРАЙОН 9, дом 7, кв/офис 9, пн–сб 12:00–20:00.
          </p>
