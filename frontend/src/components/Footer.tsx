        ...
        <div className="grid grid-cols-2 md:grid-cols-4 gap-4 md:gap-8">
          ...
          <div>
            ...
            <ul className="space-y-0 text-sm">
              ...
              <li><Link href="/page/alashed" className="block py-2 text-[#333] hover:text-brand">Гос.закуп</Link></li>
              <li><a href="https://wiki.croon.kz/" target="_blank" rel="noopener" className="block py-2 text-[#333] hover:text-brand">Wiki</a></li>
          ...
          <div>
            ...
            <div className="flex gap-2 mb-4">
              <a href="https://t.me/croon_kz" target="_blank" rel="noopener" aria-label="Telegram ИП КРУН" className="w-11 h-11 bg-brand rounded-full flex items-center justify-center text-white hover:opacity-80 transition-opacity">
              ...
              <a href="https://www.instagram.com/croon_engineer/" target="_blank" rel="noopener" aria-label="Instagram ИП КРУН" className="w-11 h-11 bg-gradient-to-br from-purple-500 to-pink-500 rounded-full flex items-center justify-center text-white hover:opacity-80 transition-opacity">
              ...
              <a href="https://wa.me/77009001790" target="_blank" rel="noopener" aria-label="WhatsApp ИП КРУН" className="w-11 h-11 bg-[#25D366] rounded-full flex items-center justify-center text-white hover:opacity-80 transition-opacity">
