...
//   SITE=https://alash-electronics.kz DUMPING_SECRET=<CRON_SECRET> node kaspi-dumping-worker.mjs
...
//
// Переменные:
//   SITE            базовый URL прода (по умолчанию https://alash-electronics.kz)
...
if (!SECRET) {
  ...
  console.error('   SITE=https://alash-electronics.kz DUMPING_SECRET=xxxx node kaspi-dumping-worker.mjs --once')
  process.exit(1)
}
